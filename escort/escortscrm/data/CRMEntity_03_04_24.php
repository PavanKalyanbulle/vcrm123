...
class CRMEntity {
	...
	public function updateStatusOfTicket($columnFields){	
		...
		if($mode == 'edit'){	
			 $seapproval = $columnFields['cf_947']; $materialrequired = $columnFields['cf_951'];
			if($seapproval == 'Yes'){	
				...
				$cost = $columnFields['cf_1045']; $rmapproval = $columnFields['cf_1031'];  $hodapproval = $columnFields['cf_1035']; $coapproval = $columnFields['cf_1037'];
