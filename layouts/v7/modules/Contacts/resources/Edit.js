...
Vtiger_Edit_Js("Contacts_Edit_Js",{},{
	...
	// 		$.ajax({
	// 		type: "GET",
	// 		url: "index.php?module=Contacts@action=demoPicklistAjax@demopick="+demopick,
	// 		success: function (response){ 

	// 		$("#Contacts_editView_fieldName_cf_867").val(response);
	// 		}
	// 	});
	// 	});
	// },
...
//         $.ajax({
//             type: "GET",
//             url: "index.php?module=Contacts&action=demoPicklistAjax2&demopick="+demopick,
//             success: function(response) {
//                 $("#Contacts_editView_fieldName_cf_959").val(response);
//             }
//         });
//     });
// },
	...
	customMethod: function() {
    $(document).on("change", "#cf_865", function() {
        var demopick = $(this).val(); // Use 'this' for efficiency and clarity
        $.ajax({
            type: "GET",
            url: "index.php?module=Contacts&action=demoPicklistAjax2&demopick=" + encodeURIComponent(demopick),
            success: function(response) {
                $("#Contacts_editView_fieldName_cf_959").val(response);
            },
	...
	// customMethod: function() {
	// 	$(document).on("change", "#cf_955", function() {
	// 		var demopick = $("#cf_955").val();
			
	// 		$("#Contacts_editView_fieldName_cf_959").val(demopick);
	...
	// 	alert("contact :: custom Modulepavan")
	// },
	...
	registerBasicEvents: function (container) {
		this._super(container);
		 console.log("in here pavan"); alert("in here pavan");
